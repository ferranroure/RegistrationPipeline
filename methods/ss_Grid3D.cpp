        ...
        for (int i=1; i<=nCells; i++){
            ...
            for (int j=1; j<=nCells; j++){
                ...
                for (int k=1; k<=nCells; k++){
                    ...
                    Point *c = new Point(pxmin + (fabs(pxmax-pxmin))/2, pymin + (fabs(pymax-pymin))/2, pzmin + (fabs(pzmax-pzmin))/2);
...
//                        if( (pA->getDescriptor()->isAvailable() && pB.getDescriptor()->isAvailable()) && (pA->getDescriptor()->compare(pB.getDescriptor()) > threshold)){
...
//                        else{
                        ...
                        int pairedPointsTemp = 0;
                            ...
                            if( (percPairedPointsTemp > percPairedPoints)){
                                ...
                                xmin=pxmin; xmax=pxmax; ymin=pymin; ymax=pymax; zmin=pzmin; zmax=pzmax;
